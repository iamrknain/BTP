...
\textit{Proof.} Let \(f(z)\) be a mapping function as in the power series above, normalized such that \(f(a) = 0\) and \(f'(a) = 1\). Then the area of the image of \(D\) is:
\begin{align*}
\mathrm{area}(f(D)) = \iint_{D} |f'(z)|^2 \, dS_z
